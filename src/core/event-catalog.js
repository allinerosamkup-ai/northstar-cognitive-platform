...
const LOG_ONLY_EVENTS = new Set(["collective.started", "resident.paused", "file.written", "settings.changed", "session.started", "assignment.proposed", "agent.created", "agent.dismissed"]);
